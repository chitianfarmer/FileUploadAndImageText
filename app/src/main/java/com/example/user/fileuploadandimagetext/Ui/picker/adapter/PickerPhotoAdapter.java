...
//			viewHolder = new ViewHolder();
			...
			TextView tv_image_path = (TextView) convertView.findViewById(R.id.tv_image_path);
			tv_image_path.setText(getItem(position).getAbsolutePath());
		onPhotoSelectClickListener.onPhotoSelectClick(getItem(position));
...
//			Log.d("slj","PhotoInfo的集合:---"+list.size() +"----PhotoInfo的地址:---"+photoInfo.getAbsolutePath());
//		}
