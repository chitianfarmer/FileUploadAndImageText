package com.example.user.fileuploadandimagetext.Utils.media;
...
import com.example.user.fileuploadandimagetext.Utils.log.LogUtil;
...
public class ImageUtil {
	...
	public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(MyApplication.getContext().getResources(), R.drawable.nim_image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
