package com.example.user.fileuploadandimagetext.Ui.picker.util;
...
public class ImageGetUtils {
     ...
     * @return
     */
    private static List<CustomGallery> getAllIMage(Context context){
...
//        final String orderBy = MediaStore.Images.Media.DATE_TAKEN;
        ...
        Cursor imagecursor =  mContentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, null);
