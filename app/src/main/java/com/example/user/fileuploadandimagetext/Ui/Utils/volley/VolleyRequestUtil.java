...
//                headers.put("Accept", "application/json");
     ...
     * volleyListenerInterface：VolleyListenerInterface接口；
     * */
    public static void RequestPostByJson2(Context context, final String url, String tag, final Map<String, String> map,VolleyJsonObjectListenerInterface listenerInterface) {
        // 清除请求队列中的tag标记请求
//        MyApplication.getHttpQueue().cancelAll(tag);
